...
2026-09-08 작업 트리 기준입니다. 파일별 전체 원문과 최신 행 수는 [생성 목록](../generated/README.md)을 참조합니다.
...
|---|---|---|---|
| `engine/src/main.cpp` (1126행) | 초기화·CLI·복구/라우팅 IO 조율·메시지 전달·진단 덤프. 음색 요청과 응답 조립도 개별 담당으로 이동 | 진단과 서비스 수명 경계가 남음 | 같은 장치 선택·복구 순서·현재 IPC·출력 유지 |
